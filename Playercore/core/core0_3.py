...
def SPOL(files,timestart):
  ...
  for line in files.readlines(): 
    ...
    #错误警示
  if warn!=0:
      print(msg("Warning_Warn_Count").format(warn))
      for i in warnline:
          print(msg("Warning_Warn_Info").format(i[0],i[1]))
      print()
  if texterror!=0:
      print(msg("Warning_Texterror_Count").format(texterror))
      for i in texterrorline:
          print(msg("Warning_Texterror_Info").format(i[0],i[1]))
      print()
  if formatwarn!=0:
      print(msg("Warning_Formatwarn_Count").format(formatwarn))
      for i in formatwarnline:
          print(msg("Warning_Formatwarn_Info").format(i[0],i[1]))
      print()
  if numseterror!=0:
      print(msg("Warning_Numseterror_Count").format(numseterror))
      for i in numseterrorline:
          print(msg("Warning_Numseterror_Info").format(i[0],i[1]))
      print()
